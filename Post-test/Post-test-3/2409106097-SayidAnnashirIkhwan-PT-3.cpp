                ...
                if (panjang[0] < MAX_TIKET) {
                    ...
                    if (index > 0 && index <= JUMLAH_STASIUN) {
                        if (jumlahTiketStasiun[index - 1] > 0) {
                            ...
                            getline(cin, tiket[panjang[0]].namaPenumpang);
                            cout << "Masukkan Jumlah Tiket: ";
                            cin >> tiket[panjang[0]].jumlahTiket;
                            cin.ignore(); // Membersihkan buffer

                            if (tiket[panjang[0]].jumlahTiket <= jumlahTiketStasiun[index - 1]) {
                                tiket[panjang[0]].stasiunDipilih = index - 1;
                                tiket[panjang[0]].totalHarga = tiket[panjang[0]].jumlahTiket * harga[index - 1];
                                jumlahTiketStasiun[index - 1] -= tiket[panjang[0]].jumlahTiket;
                                panjang[0]++;
